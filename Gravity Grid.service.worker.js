...
/** @type {string} */
const CACHE_VERSION = '1759885635|43753634643';
/** @type {string} */
const CACHE_PREFIX = 'Graviball-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Gravity Grid.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Gravity Grid.html","Gravity Grid.js","Gravity Grid.offline.html","Gravity Grid.icon.png","Gravity Grid.apple-touch-icon.png","Gravity Grid.audio.worklet.js","Gravity Grid.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Gravity Grid.wasm","Gravity Grid.pck"];
